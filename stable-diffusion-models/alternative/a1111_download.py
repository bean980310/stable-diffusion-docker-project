...
ckpt_dir = ['sd15', 'sd2', 'sdxl', 'pony', 'ilxl', 'sd3']
[makedirs(os.path.join("./models/Stable-diffusion", dir)) for dir in ckpt_dir]

vae_dir=['sd15', 'sd2', 'sdxl', 'pony', 'ilxl', 'sd3']
[makedirs(os.path.join("./models/VAE", dir)) for dir in vae_dir]

lora_dir=['sd15', 'sd2', 'sdxl', 'pony', 'ilxl', 'sd3']
[makedirs(os.path.join("./models/Lora", dir)) for dir in lora_dir]

embedding_dir=['sd15', 'sd2', 'sdxl', 'sd3']
[makedirs(os.path.join("./embeddings", dir)) for dir in embedding_dir]
...
models_dir='./models'
model_types=['Stable-diffusion', 'ControlNet', 'deepbooru', 'BLIP', 'GFPGAN', 'ESRGAN', 'hypernetworks', 'karlo', 'Lora', 'VAE', 'VAE-approx', 'adetailer']
model_versions=['sd15', 'sd2', 'sdxl', 'pony', 'ilxl', 'sd3']
...
sd15_ckpt_dir=model_dirs.dirs['sd15']['Stable-diffusion']
sd15_vae_dir=model_dirs.dirs['sd15']['VAE']
sd15_lora_dir=model_dirs.dirs['sd15']['Lora']
sd15_controlnet_dir=model_dirs.dirs['sd15']['ControlNet']
sd15_embedding_dir='./embeddings/sd15'
...
sd2_ckpt_dir=model_dirs.dirs['sd2']['Stable-diffusion']
...
sdxl_ckpt_dir=model_dirs.dirs['sdxl']['Stable-diffusion']
sdxl_vae_dir=model_dirs.dirs['sdxl']['VAE']
sdxl_lora_dir=model_dirs.dirs['sdxl']['Lora']
sdxl_controlnet_dir=model_dirs.dirs['sdxl']['ControlNet']
sdxl_embedding_dir='./embeddings/sdxl'
...
pony_ckpt_dir=model_dirs.dirs['pony']['Stable-diffusion']
pony_vae_dir=model_dirs.dirs['pony']['VAE']
pony_lora_dir=model_dirs.dirs['pony']['Lora']
...
ilxi_ckpt_dir=model_dirs.dirs['ilxl']['Stable-diffusion']
...
hf_hub_download(repo_id="Kim2091/AnimeSharp", filename="4x-AnimeSharp.pth", local_dir="./models/ESRGAN")
...
# Download LDSR Model
lsdr_dir='./models/LDSR'
os.makedirs(lsdr_dir)
download("https://heibox.uni-heidelberg.de/f/31a76b13ea27482981b4/?dl=1", f"{lsdr_dir}/2021-11-02T06-24-44-project.yaml")
...
git_download(repo_id="TencentARC/GFPGAN", filename="GFPGANv1.4.pth", tag='v1.3.4', local_dir='./models/GFPGAN')
...
git_download(repo_id="TencentARC/GFPGAN", filename="CodeFormer.pth", tag='v1.3.4', local_dir="./models/Codeformer")
...
git_download(repo_id='TencentARC/GFPGAN', filename='RestoreFormer.pth', tag='v1,3,4', local_dir='./models/Codeformer')
...
snapshot_download(repo_id="Bingsu/adetailer", allow_patterns="*.pt", ignore_patterns="*-seg.pt", local_dir="./models/adetailer/bbox")
...
download("https://dl.fbaipublicfiles.com/segment_anything/sam_vit_h_4b8939.pth", "./models/sam/sam_vit_h_4b8939.pth")
...
download("https://dl.fbaipublicfiles.com/segment_anything/sam_vit_l_0b3195.pth", "./models/sam/sam_vit_l_0b3195.pth")
...
download("https://dl.fbaipublicfiles.com/segment_anything/sam_vit_b_01ec64.pth", "./models/sam/sam_vit_b_01ec64.pth")
...
clip_vision_dir='./models/clip_interrogator'
