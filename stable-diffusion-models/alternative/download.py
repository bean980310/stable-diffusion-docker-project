...
# Delete cache
get_ipython().system('rm -rf {flux_ckpt_dir}/.cache')
...
# Delete cache
get_ipython().system('rm -rf {flux_vae_dir}/.cache')
...
# Delete cache
get_ipython().system('rm -rf {flux_lora_dir}/.cache')
