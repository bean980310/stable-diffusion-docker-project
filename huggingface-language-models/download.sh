...
huggingface-cli download meta-llama/Llama-3.2-1B --include "original/*" --local-dir=./models/Llama-3.2-1B
huggingface-cli download meta-llama/Llama-3.2-3B --include "original/*" --local-dir=./models/Llama-3.2-3B
