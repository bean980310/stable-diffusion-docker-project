...
wget -P sd-models/ControlNet/SD15 -i ./download_link/download_controlnet_sd15.txt

echo "Downloading ControlNet model for SD XL"
wget -P sd-models/ControlNet/SDXL -i ./download_link/download_controlnet_sdxl_stabilityai.txt
